...
<div class="p-8">
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-600 mt-1">Suivez toutes les commandes de la plateforme</p>
    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach($orders as $order)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-semibold text-gray-900">{{ number_format($order->total_amount, 2) }} DT</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($order->payment)
    ...
    @else
        <div class="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <p class="mt-2 text-sm text-gray-500">Aucune commande ne correspond à vos critères de recherche.</p>
        </div>
    @endif
</div>
@endsection
